...
import {
  RiDashboardLine, RiBriefcaseLine, RiGroupLine, RiClipboardLine,
...
const NAV_ITEMS = [
  ...
  { to: "/setup",      icon: RiBriefcaseLine, label: "Setup Interview" },
  { to: "/candidates", icon: RiGroupLine,     label: "Candidates"      },
  { to: "/evaluation", icon: RiClipboardLine, label: "Evaluations"     },
...
export function Sidebar() {
  ...
  return (
    ...
    >
        ...
        {!collapsed && (
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.background = "var(--acg2)";
            }}
            onMouseLeave={(e) => {
      ...
      {/* Expand toggle when collapsed — sits below logo */}
      {collapsed && (
        <button
          onClick={toggle}
          style={{
      ...
      >
        <button
          ...
          title={collapsed ? "1 Live Interview" : undefined}
          style={{
            display: "flex",
            alignItems: "center",
            gap: 9,
        ...
        <button
          ...
          title={collapsed ? "Jane Smith" : undefined}
          style={{
            display: "flex",
            alignItems: "center",
            gap: 9,
        ...
        >
          <Avatar initials="JS" size={26} color="#7C6FFF" />
          {!collapsed && (
            <div style={{ textAlign: "left", whiteSpace: "nowrap" }}>
              <div style={{ fontSize: 12, fontWeight: 600, color: "var(--color-ink)" }}>Jane Smith</div>
              <div style={{ fontSize: 10, color: "var(--color-ink3)" }}>Admin</div>
            </div>
          )}
        </button>
      </div>
